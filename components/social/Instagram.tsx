...
async function Instagram() {
	...
	return (
		<div className="space-y-10 pt-10 pb-32 bg-ellipse from-custom-red-100 to-custom-red-400 h-full relative">
			<h2 className={cn('p-5 select-none flex items-center justify-center gap-x-5 ')}>
				<TextGenerateEffect
					words="Share More Ice Cream On Instagram!"
					textClassName={cn('!text-white text-5xl drop-shadow-black-md', font.className)}
				/>
			...
			<MaxWidthWrapper>
				{posts && (
					<Suspense fallback={<p className="text-center text-4xl mt-10 animate-pulse">Loding Posts . . .</p>}>
