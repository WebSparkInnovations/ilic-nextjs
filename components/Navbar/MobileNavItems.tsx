	...
	return (
		<div className="flex lg:hidden h-max items-end px-5 z-50">
			...
			<Sheet>
				...
				<SheetContent
					side="top"
					className="!flex !flex-col items-center sm:gap-y-5 !bg-gray-100/90 !border-none"
				>
					<SheetHeader>
						<SheetTitle className={cn('!text-5xl text-center text-white font-bold', font.className)}>
