...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact I Love Ice cream via phone or e-mail & adress '
};

function ContactUsPage() {
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center bg-ellipse from-pink-300 to-rose-900 px-5 py-20">
